Overview:
********************************
Script to pull room attributes from an Airbnb search result. Attributes inlcude price, location, room type, number of bed/bathrooms, and number of guests. Output is parsed and read into csv format. Searches for and collects data from next page of results until the end is reached. 
