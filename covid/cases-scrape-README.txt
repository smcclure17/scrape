Overview:
************************
Script to scrape Javascript rendered table into Pandas dataframe. Table includes the number of average daily cases per 100k in last 7 days for each state according to the CDC (https://covid.cdc.gov/covid-data-tracker/#cases_casesper100klast7days)
